...
# Path to config dir
MODEL="blip_union/blip_featurefusion"  # <--- Change this to the model you want to run
MODEL_DIR="$SRC/models_scripts/$MODEL"
UNION_MODEL_DIR="$SRC/models_scripts/blip_union"
SIZE="large"
...
conda activate blip # <--- Change this to the name of your conda environment
