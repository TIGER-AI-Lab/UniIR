...
def build_model_from_config(config):
    ...
    if model_name == "CLIPScoreFusion":
        from models_scripts.uniir_clip.clip_scorefusion.clip_sf import CLIPScoreFusion

        # initialize CLIPScoreFusion model
        model_config = config.model
        mbeir_dir = config.mbeir_dir
        download_root = os.path.join(mbeir_dir, model_config.pretrained_clip_model_dir)
        ...
        from models_scripts.uniir_clip.clip_featurefusion.clip_ff import CLIPFeatureFusion_OPENAI
        ...
        from models_scripts.uniir_blip.blip_scorefusion.blip_sf import BLIPScoreFusion
        model_config = config.model
        model = BLIPScoreFusion(
            med_config=os.path.join("uniir_blip", "configs/med_config.json"),
        ...
        from models_scripts.uniir_blip.blip_featurefusion.blip_ff import BLIPFeatureFusion
        model_config = config.model
