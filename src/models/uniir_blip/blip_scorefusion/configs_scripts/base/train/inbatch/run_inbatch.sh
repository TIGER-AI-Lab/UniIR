...
# Path to config dir
MODEL="uniir_blip/blip_scorefusion"  # <--- Change this to the model you want to run
...
export CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 # <--- Change this to the CUDA devices you want to us
NPROC=6
